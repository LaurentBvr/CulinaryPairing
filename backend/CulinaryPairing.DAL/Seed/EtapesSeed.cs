...
public static class EtapesSeed
{
    public static async Task SeedAsync(CulinaryPairingDbContext context)
    {
        ...
        var etapes = new List<Etape>
        {
            ...
            // ===== Recette 7 : Carpaccio de Saint-Jacques aux agrumes (20 min, cru) =====
            ...
            new() { IdRecette = 7, NumeroEtape = 2, Description = "Préparer la marinade : presser le citron vert et l'orange, mélanger les jus avec l'huile d'olive. Saler à la fleur de sel, poivrer." },
            new() { IdRecette = 7, NumeroEtape = 3, Description = "Arroser les Saint-Jacques de marinade 5 minutes avant de servir : la chair va légèrement raffermir et se parfumer." },
            new() { IdRecette = 7, NumeroEtape = 4, Description = "Parsemer de coriandre fraîche ciselée et servir immédiatement avec un peu de zeste d'agrumes." },

            // ===== Recette 8 : Tartare de boeuf classique (25 min, cru) =====
            ...
            new() { IdRecette = 8, NumeroEtape = 2, Description = "Émincer finement l'échalote et les cornichons. Hacher le persil." },
            new() { IdRecette = 8, NumeroEtape = 3, Description = "Mélanger le boeuf haché avec l'échalote, les cornichons et le persil. Saler, poivrer." },
            ...
            // ===== Recette 9 : Soupe Pho au boeuf (4h30, mijote long) =====
            ...
            new() { IdRecette = 9, NumeroEtape = 5, Description = "Cuire les nouilles de riz selon les instructions du paquet. Trancher le filet de boeuf en lamelles très fines (cru, il cuira au contact du bouillon brûlant)." },
            new() { IdRecette = 9, NumeroEtape = 6, Description = "Dans des bols, disposer les nouilles, les tranches de boeuf cru. Verser le bouillon brûlant filtré. Servir avec coriandre, basilic thaï et quartiers de citron vert." },

            // ===== Recette 10 : Magret de canard à l'orange (45 min, roti) =====
            ...
            new() { IdRecette = 10, NumeroEtape = 6, Description = "Trancher les magrets en biais, napper de sauce à l'orange, servir avec une purée de pommes de terre ou des légumes glacés." },
            ...
            // ===== Recette 12 : Burger gourmet bacon-cheddar (30 min, grille) =====
            ...
            new() { IdRecette = 12, NumeroEtape = 4, Description = "Toaster les pains à burger côté mie. Trancher les tomates, l'oignon en rondelles fines. Détacher les feuilles de salade." },
            new() { IdRecette = 12, NumeroEtape = 5, Description = "Monter le burger dans l'ordre : pain, salade, tomate, steak au cheddar, bacon, oignon, pain. Servir immédiatement avec frites maison." },
